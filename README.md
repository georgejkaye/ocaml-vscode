...
The `_build` folder is generally the standard for all OCaml projects, including those built with more sophisticated tools such as Dune.
...
**Usage:** `./compile.sh <relative module path>`

**Example:** `./compile.sh src/Foo/A`
...
**Usage:** `./run.sh <relative module path>`

**Example:** `./run.sh src/Foo/A`
